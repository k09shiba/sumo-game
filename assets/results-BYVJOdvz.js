import{a as k,G as r,b,p as g,q as l,s as S,t as P}from"./index-CosIwvJz.js";import{D as c,m as _,n as y,l as w,e as p,o as E,p as z,f as $,q as O,K as Y}from"./disciple-ItPjZfCN.js";import{g as H,c as B,b as L,d as j}from"./basho-xtMNCeOa.js";import{c as C,a as A,u as T,r as K,b as V,d as W}from"./events-BemR4t1c.js";import{r as R}from"./facility-B5FiZDS6.js";function q(o,e){if(c[o.divIdx].matches-e,o.divIdx===_){J(o,e);return}if(o.divIdx===y){U(o,e);return}const t=F(o,e);let n=o.pos+t,a=o.divIdx;for(;n<1&&a<c.length-1;){const d=1-n,u=c[a].maxPos;a++;const i=c[a];if(a>=w){const m=p(d/u,0,1);n=Math.round(i.maxPos*(1-m*.55))}else{const m=p(d/u,0,1);n=Math.round(i.maxPos*(1-m*.65))}n=p(n,1,i.maxPos)}for(;a>0&&n>c[a].maxPos;){const d=n-c[a].maxPos,u=c[a].maxPos;a--;const i=c[a];if(a===E)n=i.maxPos;else{const m=p(d/u,0,1);n=Math.round(i.maxPos*m*.65),n=p(n,1,i.maxPos)}}const h=o.divIdx;o.divIdx=p(a,0,c.length-1),o.pos=p(n,1,c[o.divIdx].maxPos),Q(o,h)}function F(o,e){const s=c[o.divIdx],t=s.matches-e,n=e-t,a=o.divIdx;if(a===E)return n===0?0:-n*7+$(-2,2);if(a===1)return e===7?-(s.maxPos+10):-n*10+$(-3,3);if(a===2)return e===7?-(s.maxPos+10):-n*9+$(-3,3);if(a===O){if(e===7&&o.pos<=5)return-(s.maxPos+15);if(e===7)return-25+$(-5,0);const u=o.pos/s.maxPos>.5?9:4;return-n*u+$(-3,3)}const h=o.pos/s.maxPos;return-Math.round(n*(1.5+h*.8))+$(-1,2)}function U(o,e){if(e>=8){o.ozekiFallback=0;const s=-Math.floor((e-8)*.8);o.pos=p(o.pos+s,1,c[y].maxPos)}else o.ozekiFallback++,o.ozekiFallback>=2?(o.divIdx=z,o.pos=3,o.ozekiFallback=0,f("ozeki_fall",o)):f("ozeki_warning",o);N(o,e)}function J(o,e){e<8?(o.yokozunaWarning++,o.yokozunaWarning>=3?f("yokozuna_retire_forced",o):f("yokozuna_warning",o)):o.yokozunaWarning=0}function N(o,e){var u,i;const s=o.lastTwoBashoWins||[];if(s.push(e),s.length>2&&s.shift(),o.lastTwoBashoWins=s,s.length<2)return;const[t,n]=s,a=o.yushoRecord.length>0&&((u=o.yushoRecord[o.yushoRecord.length-1])==null?void 0:u.bashoIdx)===r.bashoCount-1,h=o.yushoRecord.length>0&&((i=o.yushoRecord[o.yushoRecord.length-1])==null?void 0:i.bashoIdx)===r.bashoCount;(a&&h||h&&n>=13&&t>=12)&&o.divIdx===y&&f("yokozuna_promotion",o)}function Q(o,e,s){e<w&&o.divIdx>=w&&!o.promotedJuryo&&(o.promotedJuryo=!0,o.keshoMawashi="akaishi",f("juryo_promotion",o),k({icon:"🎊",text:`${o.name} 十両昇進！`})),e<z&&o.divIdx>=z&&!o.promotedMakunouchi&&(o.promotedMakunouchi=!0,f("makunouchi_promotion",o),k({icon:"🎊",text:`${o.name} 幕内昇進！`})),e<y&&o.divIdx>=y&&!o.promotedOzeki&&(o.promotedOzeki=!0,f("ozeki_promotion",o),k({icon:"🏅",text:`${o.name} 大関昇進！`})),e<_&&o.divIdx>=_&&!o.promotedYokozuna&&(o.promotedYokozuna=!0,f("yokozuna_promotion_confirmed",o),k({icon:"👑",text:`${o.name} 横綱昇進！`}))}const D=[];function f(o,e){D.push({type:o,data:e})}function G(){return D.splice(0)}function Z(o){return o.age>=40?"forced":o.age>=36?"advisory":null}function lo(){var h,d,u;const o=document.getElementById("screen-results"),e=X(),s=H().name;o.innerHTML=`
    <div class="results-wrap">
      <div class="results-header">
        <h2>場所結果発表</h2>
        <div>令和${r.year}年　${s}</div>
    ...
    </div>`;const t=B();r.ryo=(r.ryo||0)+t,document.getElementById("income-section").innerHTML=`
    ...
    </div>`,L(),j();const n=C();n&&(r.ryo+=n.bonus,document.getElementById("annual-award-section").innerHTML=`
...
契約しますか？`,choices:[{label:"✅ 契約する",fn:()=>{W(a.id),b(),P(`${a.name}と契約しました！毎場所+${a.income}両！`)}},{label:"断る",fn:()=>{}}]}),g()},500),r.sponsors&&r.sponsors.length>0){const i=r.sponsors.reduce((v,M)=>v+M.income,0),m=document.getElementById("income-section");m&&(m.innerHTML+=`
        <div class="income-row">
...
優勝回数：${i.yushoRecord.length}回`}),g()},1e3);break}}(d=document.getElementById("btn-back-to-main"))==null||d.addEventListener("click",()=>{r.phase="main",S("main")}),(u=document.getElementById("res-save-btn"))==null||u.addEventListener("click",()=>{b(),P("セーブしました！")})}function X(){var e,s;const o=[];for(const t of r.disciples){if(t.retired)continue;const n=t.wins||0,a=t.losses||0;c[t.divIdx],T(t);const h=t.divIdx,d=t.pos;q(t,n);const u=G();oo(u,t);const i=((e=t.yushoRecord)==null?void 0:e.some(x=>x.bashoIdx===r.bashoCount))??!1,m=((s=t.sanshoRecord)==null?void 0:s.slice(-1))||[],v=Z(t);v==="forced"?so(t):v==="advisory"&&!t._advisoryShown&&(t._advisoryShown=!0,l({em:"🎋",title:`${t.name}引退勧告`,text:`${t.name}は${t.age}歳。
引退を考える年齢です。
